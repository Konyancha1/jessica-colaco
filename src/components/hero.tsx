...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.025] pointer-events-none" style={{ backgroundImage: "linear-gradient(#C9A84C 1px,transparent 1px),linear-gradient(90deg,#C9A84C 1px,transparent 1px)", backgroundSize: "80px 80px" }} />
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-8">
            ...
            <div className="mt-10 flex flex-wrap gap-4 animate-slide-up" style={{ animationDelay: "0.5s" }}>
              <button onClick={() => scrollTo("masterclass")} className="group relative px-8 py-4 bg-[#C9A84C] text-[#0A0A0A] text-sm tracking-[0.15em] uppercase font-semibold overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(201,168,76,0.4)]">
              ...
              <button onClick={() => scrollTo("book")} className="px-8 py-4 border border-[#F0EDE6]/25 text-[#F0EDE6] text-sm tracking-[0.15em] uppercase hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all duration-300">
                Work With Me
              </button>
            </div>
          ...
          {/* Right — personal signature / availability badge */}
          <div className="hidden md:flex md:col-span-4 flex-col items-end gap-6">
            ...
            <div className="border border-[#1E1E1E] p-6 bg-[#080808] w-full">
              <p className="text-[10px] text-[#555] tracking-widest uppercase mb-3">Featured In</p>
              <div className="flex flex-col gap-2">
                {["TechCrunch Africa", "The Creative Economy", "Forbes 30 Under 30"].map((f) => (
